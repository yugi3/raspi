    ...
    for num in range(10, 101, 10):
        ...
        if len(y)!= 0:
            ...
            if num == 10:
                ...
                process_time[0].append(name)
                process_time[1].append(alltime)

                i = 0
                count = 2
                while i < len(time_list):
                    ans = time_list[i+1][1] - time_list[i][1]
                    process_time[count].append(ans)
                    #print(pname,ans)
                    i= i+2
                    count = count + 1
                #print(process_time)
